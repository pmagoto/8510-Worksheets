...
ggplot(sc.rec, aes(x = state, y = state.expenditures, color = state.expenditures, fill = state.expenditures)) + geom_col() + labs( x = "State", y = "Total Expenditures", title = "Rec Expenditures by State") + theme(plot.title = element_text(hjust = 0.5))
```
...
ggplot(data = gayguidesbarchartdata, mapping = aes(x = state, y = count, color = state, fill = state)) + geom_col() +  geom_text(aes(label = count), vjust = -0.5, color = "black", size = 3.5) + labs(x = "State", y = "Number of Locations", title = "Number of Locations in 1980") + theme(plot.title = element_text(hjust = 0.5))
```
...
ggplot(data = gg.risk, mapping = aes(x= Year, y= count)) + geom_line(color = "red") + scale_x_continuous(breaks = seq(min(gayguidesreligious$Year), max(gayguidesreligious$Year), by = 1)) + geom_text(aes(label = count), vjust = -0.5, hjust = -0.5, size = 3, color = "black") + geom_point(color="black") + labs(y = "Number of Locations Using Risk IDs", x = "Years", title = "Use of Risk IDs Over Time in GayGuides") + theme(plot.title = element_text(hjust = 0.5)) + theme_dark()
```
...
ggplot(data = SCrecdata, mapping = aes(x= city, y= total_expenditures, color = total_expenditures, fill = total_expenditures)) + geom_col() + labs(x= "City in South Carolina", y= "Total Expenditure", title= "Total Expenditures in South arolina Cities (1930)") + geom_text(aes(label = total_expenditures), vjust = -0.5, color = "black", size = 3.5) + theme(plot.title = element_text(hjust = 0.5))
```
