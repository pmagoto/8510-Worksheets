...
for (p in 1:length(statepopulations$X1800)) {
  population <- statepopulations$X1800[p]
  if (is.na(population)) {
    next  
  }
...
bwv.stateandoccupation <- function(State.or.Province.of.Birth, Occupation){
  data("BostonWomenVoters")
  
  for (n in 1:length(BostonWomenVoters$State.or.Province.of.Birth)){ 
    if (BostonWomenVoters$State.or.Province.of.Birth[n] == State.or.Province.of.Birth && BostonWomenVoters$Occupation[n] == Occupation ){
      print(paste(BostonWomenVoters$Name[n], "and she is a", Occupation, "she is also from", State.or.Province.of.Birth))
    }
    }
}

bwv.stateandoccupation ("Massachusetts" , "Typist" )
bwv.stateandoccupation ("North Carolina" , "housewife" )
bwv.stateandoccupation ("Georgia" , "Housewife" )
